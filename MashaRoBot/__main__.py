...
PM_START_TEXT = """
𝙷𝙴𝚈,my name is 𝙶𝙰𝙽𝙶𝚂𝚃𝙴𝚁
𝙸'𝙰𝙼 𝙰𝙽 𝙰𝙽𝙸𝙼𝙴 𝚃𝙷𝙴𝙼𝙴𝙳 𝙶𝚁𝙾𝚄𝙿 𝙼𝙰𝙽𝙰𝙶𝙸𝙽𝙶 𝙱𝙾𝚃! BY SATYA AND 𝙂𝘼𝙉𝙂𝙎𝙏𝙀𝙍 DEVS 𝙲𝙻𝙸𝙲𝙺` *📚𝙲𝙾𝙼𝙼𝙰𝙽𝙳𝚂* `𝙱𝚄𝚃𝚃𝙾𝙽 𝙱𝙴𝙻𝙾𝚆 𝚃𝙾 𝙴𝚇𝙿𝙻𝙾𝚁𝙴 𝙼𝙾𝚁𝙴 𝙰𝙱𝙾𝚄𝚃 𝙼𝙴 𝙰𝙽𝙳 𝙼𝚈 𝙵𝚄𝙽𝙲𝚃𝙸𝙾𝙽𝚂 [.](https://telegra.ph/file/1dfcc3f15805e2a6aad8c.jpg)
"""

buttons = [
    [
        InlineKeyboardButton(
            text="🦋 𝙰𝙳𝙳 𝙼𝙴 𝚃𝙾 𝚈𝙾𝚄𝚁 𝙶𝚁𝙾𝚄𝙿 🦋", url="t.me/Mrgangbot?startgroup=true"),
    ],
    [
...
𖣘 *If you facing any issue or find any bugs in any command then you can report it in @MRGangsterbot* [.](https://telegra.ph/file/1dfcc3f15805e2a6aad8c.jpg)
"""
